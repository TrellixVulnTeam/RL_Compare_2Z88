...
def build_forest_iter_charts(exercises=100):
    ...
    for algorithm, alg_name in [(forest_pol_iter, 'Policy Iteration')]:
        ...
        for state in states:
            ...
            converge_data.append(result.iter)
    ...
    plt.title(f'Time vs Convergence for Policy Iteration', fontsize=13)
    plt.legend(loc='upper right')
    plt.show()
    ...
    plt.title(f'Time vs Convergence Iterations for Value Iteration', fontsize=13)
    plt.legend(loc='upper right')
    plt.show()
